export default {
	...
	"colors": {
		...
		"activityBar.border": "#30604A60",
		"activityBar.foreground": "#E2E2E2",
		"activityBarBadge.background": "#6C9C87",
		"activityBarBadge.foreground": "#222222",
		"badge.background": "#22222230",
		"badge.foreground": "#6C9C87",
	...
	"tokenColors": [
		...
		},
		{
			"scope": [
				...
				// PYTHON
				"punctuation.definition.string.begin.py",
				"punctuation.definition.string.end.py"
			],
			"settings": {
				"foreground": "#3A7359"
			}
